  ...
  return (
    <>
      <div id="top-menu" className="fixed top-0 left-0 right-0 bg-white dark:bg-[#3F3F46] z-50 shadow-lg shadlow-black/50 selection:text-black selection:bg-blue-700 dark:selection:bg-[#EEEEEE]">
        <div className={`px-4 py-2 h-12 flex flex-row justify-between ${isMounted ? 'md:grid md:grid-cols-3 md:items-center' : ''}`}>
          <div id="icon-menu" className="hover:cursor-pointer text-2xl material-symbols-outlined text-black dark:text-white" onClick={toggleMenu}>

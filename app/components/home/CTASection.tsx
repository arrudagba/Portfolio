...
export default function CTASection({ theme = 'dark' }) {
  ...
  return (
    <section className="relative py-20 lg:py-32 overflow-hidden" style={{ backgroundColor: bg }}>
      ...
      {/* Background Grid with fade on sides */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 backdrop-blur-sm border rounded-full px-6 py-2 mb-8" style={{ backgroundColor: surface, borderColor: surface }}
          >
          ...
          <motion.h2
            ...
            className="text-4xl lg:text-6xl font-bold mb-6 leading-tight" style={{ color: titleColor }}
          >
          ...
          <motion.p
            ...
            className="text-lg lg:text-xl mb-10 max-w-2xl mx-auto" style={{ color: textSecondary }}
          >
